...
public class GraphOld<T> {
	...
	public GraphOld(boolean directed) {
		nodes = new ArrayList<>();
		this.directed = directed;
	}
	
	public GraphOld(boolean directed, int numNodes, T value) {
		this(directed, numNodes, i -> value);
	}
	
	public GraphOld(boolean directed, int numNodes, Function<Integer, T> values) {
